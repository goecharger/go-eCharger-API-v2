...
|	car	|	R	|	optional<uint8_t>	|	Status	|	charge ctrl car state, null if no connection to chargectrl established (Unknow	n/Error=0, Idle=1, Charging=2, WaitCar=3, Complete=4, Error=5, Initializing=6) |
...
|	fsc	|	R	|	int32_t	|	Config	|	failsafeLimitCountdown	|
|	fse	|	R	|	bool	|	Config	|	failsafeLimitEnabled	|
|	fsi	|	R	|	uint8_t	|	Config	|	failsafeLimit	|
...
|	iso2en	|	R/W	|	uint8_t	|	Config	|	iso15118Enablement (Off = 0, Optional = 1, Forced = 2)	|
...
|	osr	|	R/W	|	bool	|	Config	|	stop charging on reboot if OCPP enabled	|
...
|	rev	|	R	|	string	|	Constant	|	Hardware revision	|
...
|	txt	|	R/W	|	int32_t	|	Config	|	transaction timeout	|
