...
## Using the App to enable and verify the OCPP connection
...
| ocppt    | OCPP accept time provided by backend in BootNotification confirmation | bool | R/W | Config || ocppck   | OCPP client key               | string   | R/W  | Config   |
| ocppio   | OCPP currently set as inoperable (can be changed by backend by using ChangeAvailability messages) | bool | R/W | Config || ocppcc   | OCPP client cert              | string   | R/W  | Config   |
