...
|	 awpl       	|	 W          	|	 get: legacy set: JsonObject  		|	 Status        	|	 awattar price list (v2), timestamps are measured in unix-time, seconds since 1970   	|
...
|	 ocppti     	|	 R/W        	|	 optional<int>                		|	 Status        	|	 OCPP transaction id                                                                 	|
...
|	 wat        	|	 R          	|	 unsigned int                 		|	 Config        	|	 WiFi dual antenna mode ANT0=0, ANT1=1, AUTO=2                                       	|
